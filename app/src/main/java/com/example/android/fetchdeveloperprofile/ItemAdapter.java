package com.example.android.fetchdeveloperprofile;
...
import com.example.android.fetchdeveloperprofile.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public ItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =
                LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_user, viewGroup, false);
